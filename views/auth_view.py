...
def user():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            print("Error al crear el usuario:", str(e))  # Esto muestra el error en la consola de Flask
        ...
        try:
            ...
            if admin:
                return jsonify(UserSchema().dump(users, many=True)), 200
            else:
                return jsonify(MinimalUserSchema().dump(users, many=True)), 200
        except Exception as e:
